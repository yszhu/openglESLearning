package com.example.admin.vertexarrayobject;
...
public class VAORenderer implements GLSurfaceView.Renderer
{
    ...
    public void onSurfaceCreated (GL10 glUnused, EGLConfig config )
    {
        ...
        //the vertex array object just like a snapshot for status of
        //program vertex data which can be updated by glBindBuffer, glVertexAttribPointer,
        //glEnableVertexAttribArray and glDisableVertexAttribArray.
        //the updating just makes difference on new VAO,
        //so program can switch vertex status easily,
        //glBindVertexArray bind current VAO,and binding steps end with glBindVertexArray function too,
        //but the param is the default 0,just like VBO
        //note 4.1 by yszhu
        // Generate VAO Id
